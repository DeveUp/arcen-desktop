...
class Inicio (Frame):
    ...
    def crearMaquetaBase(self):
        ...
        self.barraSalida = nombreDependencia = Label(raiz,text="Barra de salida", bg="yellow")
        self.barraSalida.place(relx=0.7,rely=0,relwidth=0.3, relheight=0.10)

        self.btnSalir=Button(nombreDependencia,text="SALIR")
        self.btnSalir.place(relx=0.8,rely=0.1,relwidth=0.1, relheight=0.8,)

        self.usuario = nombreDependencia = Label(nombreDependencia,text="Leyner Ortega", bg="pink")
